...
description: Reference material on engineering practices that underpin delivery metrics.
sidebar:
  badge:
    text: Legacy
    variant: caution
...
:::caution[Legacy Content]
This page is reference material kept for context. It will be absorbed into the delivery metrics pages and removed in a future update.
:::
